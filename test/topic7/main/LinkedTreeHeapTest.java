...
import topic7.main.DescendingIntegerComparator;
...
public class LinkedTreeHeapTest {
 
    @Test
    public void test1() {
 
        Comparator<Integer> comparator = new AscendingIntegerComparator();
        Heap<Integer> heap = new LinkedTreeHeap<Integer>(comparator);
    ...
    public void test5() {
        ...
        LinkedTreeHeap.heapSort(list, new AscendingIntegerComparator());
        ...
        LinkedTreeHeap.heapSort(list, new DescendingIntegerComparator());
